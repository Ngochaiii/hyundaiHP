...
class ProductController extends Controller {
    ...
    public function index(Request $request) {
        ...
        if ($request->get('keyword')) {
            ...
            $category = \App\Models\Category::where('title','like',$request->get('keyword'))->first();
        }
        ...
        if (config('global.device') !== 'pc') {
            $product_ids = \DB::table('product_category')->where('category_id', $request->get('category_id') ?: \App\Models\Category::PRODUCT_SHOP_ID)->pluck('product_id');
            Session::put('category_id', $request->get('category_id') ?: \App\Models\Category::PRODUCT_SHOP_ID);
            ...
            $current_category = $this->categoryRepo->getCurrentCategory(isset($search['category_id']) && $search['category_id'] != 0 ? $search['category_id'] : \App\Models\Category::PRODUCT_SHOP_ID);
            ...
            if(isset($search['category_id'])){
                 if($search['category_id'] == 0){
                     $search['category_id']= \App\Models\Category::PRODUCT_SHOP_ID;
                 }
            ...
            $parent_cat = \App\Models\Category::where('id', isset($search['category_id']) && $search['category_id'] != 0 ? $search['category_id'] : \App\Models\Category::PRODUCT_SHOP_ID)
                    ->with('parentCategories')
                    ->first();
            Session::put('category_id', isset($search['category_id']) && $search['category_id'] != 0 ? $search['category_id'] : \App\Models\Category::PRODUCT_SHOP_ID);
