...
class GalleryController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $gallery_ids = \DB::table('gallery_category')->where('category_id', $request->get('category_id') ?: \App\Models\Category::GALLERY_ALBUM)->pluck('gallery_id');
        ...
        if (config('global.device') !== 'pc') {
            if(isset($search['category_id'])){
                 if($search['category_id'] == 0){
                     $search['category_id']= \App\Models\Category::GALLERY_ALBUM;
                 }
            ...
            $parent_cat = \App\Models\Category::where('id', (isset($search['category_id']) && $search['category_id'] > 0) ? $search['category_id'] : \App\Models\Category::GALLERY_ALBUM)
            ...
            $current_category = $this->categoryRepo->getCurrentCategory((isset($search['category_id']) && $search['category_id'] > 0) ? $search['category_id'] : \App\Models\Category::GALLERY_ALBUM);
