...
class CategoryController extends Controller {
    ...
    public function index($type) {
        ...
        $types = array(\App\Models\Category::TYPE_VIDEO => 'Danh mục video', \App\Models\Category::TYPE_NEWS => 'Danh mục tin tức', \App\Models\Category::TYPE_GALLERY => 'Danh mục hình ảnh', \App\Models\Category::TYPE_PRODUCT => 'Danh mục sản phẩm', \App\Models\Category::TYPE_CONSTRUCTION => 'Danh mục thi công');
    ...
    public function create($type) {
        $parent_html = StringHelper::getSelectOptions(\App\Models\Category::all()->where('type', $type));
    ...
    public function edit($type, $id) {
        ...
        $parent_html = StringHelper::getSelectOptions(\App\Models\Category::all()->where('type', $type), $record->parent_id);
