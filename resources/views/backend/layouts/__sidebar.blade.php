        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        <li class="nav-item"><a href="{{route('admin.category.index', \App\Models\Category::TYPE_NEWS)}}" class="nav-link">Danh mục</a></li>
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Sản phẩm">
                        <li class="nav-item"><a href="{{route('admin.category.index', \App\Models\Category::TYPE_PRODUCT)}}" class="nav-link">Danh mục</a></li>
