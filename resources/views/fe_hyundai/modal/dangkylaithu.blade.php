...
<script>
    ...
    // Thêm tiêu đề modal vào dữ liệu form trước khi gửi
    document.querySelector('form').addEventListener('submit', function(e) {
        // Tạo một input ẩn để chứa tiêu đề modal
        let modalTitleInput = document.createElement('input');
        modalTitleInput.type = 'hidden';
        modalTitleInput.name = 'modal_title';
        modalTitleInput.value = modalTitle.textContent;

        // Thêm input này vào form
        this.appendChild(modalTitleInput);
    });
</script>
