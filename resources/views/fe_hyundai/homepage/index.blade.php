        ...
        <div class="row wow fadeInUp">
         ...
         ?>
             <div class="car-block-four col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="inner-box">
                    <div class="image-box">
                        <figure style="height:180px;width:330px " class="image"><a href="#"><img src="{{ asset($firstImage) }}" alt="Image of {{ $product->name }}"></a></figure>
                    ...
                    <div class="content-box">
                        ...
                        <div class="btn-box">
                            <span class="mb-2 ">Giá Xe</span>
                            <small class="text-white p-2 bg-primary" style="font-size: 16px;">Giá xe {{ number_format($product->price / 1000000, 0, ',', '.') }} Triệu</small>
                            <a href="{{ route('product.detail', ['alias' => $product->alias]) }}" class="details ">Xem chi tiết<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
