...
@section('content')
        ...
        <div class="row ">
            @foreach ($products as $key => $product)
                <div class="col-md-3 col-sm-6 col-xs-12 car-home ">
                    <div class="cover"><a href='{{ route('product.detail', $product->alias) }}'><img
                                style="height:130px; !important;" class="loading lazy" data-src="{{ $product->getImage() }}"
                                src="{{ $product->getImage() }}" alt="{{ $product->title }}"></a></div>
                    <div class="car-home-detail">
                        <p class="title"><a href="{{ route('product.detail', $product->alias) }}">{{ $product->title }}</a>
                        </p>
                        <ul class="list-unstyled list-inline">
                            <li class="price">Giá xe {{ $product->price }} Triệu</li>
                            <li class="plus"><a href="{{ route('product.detail', $product->alias) }}">Xem chi tiết</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row new-home">
            @foreach ($sale_promotions as $sale_promotion)
                <div class="col-md-3 col-xs-6 dn-post dn-post-spr">
                    <div class="cover"><a href='{{ route('news.detail', $sale_promotion->alias) }}'><img
                                class="loading lazy" data-src="{{ $sale_promotion->images }}"
    ...
    <div class="container">
        ...
        <div class="row new-home">
            @foreach ($service_promotions as $service_promotion)
                <div class="col-md-3 col-xs-6 dn-post dn-post-spr">
                    <div class="cover"><a href='{{ route('news.detail', $service_promotion->alias) }}'><img
                                class="loading lazy" data-src="{{ $service_promotion->images }}"
                                src="wp-content/themes/hyundaihaiphong/includes/img/pixel.gif"
    ...
    <div class="container">
        ...
        {{-- <div class="row new-home">
            @foreach ($news as $new)
                <div class="col-md-3 col-xs-6 dn-post dn-post-spr">
                    <div class="cover"><a href='{{ route('news.detail', $new->alias) }}'><img class="loading lazy"
                                data-src="{{ $new->images }}"
                                src="wp-content/themes/hyundaihaiphong/includes/img/pixel.gif"
                                alt="{{ $new->description }}"></a>
                    </div>
                    <div class="dn-post-detail">
                        <h3 class="title"><a href="{{ route('news.detail', $new->alias) }}">{{ $new->title }}</a>
                        </h3>
        ...
        @include('fe_hyundai.homepage.news')
    </div>
    <!-- end new promotion -->
    <!-- about Hải Phòng -->
    <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="img-author">
                                        <img src="wp-content/uploads/2022/03/Dai-dien-kinh-doanh.jpg" width="100%">
                                    </div>
                ...
                <div class="col-md-5 imge-whychooseus">
                    <div class="why-img-box">
                        <div class="why-img-content">
                            <img src="{{ asset('img/dai-ly-hyundai-hai-phong-2.jpg') }}">
                            <img src="{{ asset('img/dai-ly-hyundai-hai-phong-1.jpg') }}"
